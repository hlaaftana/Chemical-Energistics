...
public class GuiElementDiffuser extends GuiContainer {
	...
	private TileElementDiffuser tile;

	public GuiElementDiffuser(EntityPlayer player, TileElementDiffuser tile) {
		super(new ContainerElementDiffuser(player, tile));
	...
	protected void drawTooltip(List<String> lines, int x, int y) {
		...
		int tooltipWidth = 0, tempWidth, xStart, yStart;
