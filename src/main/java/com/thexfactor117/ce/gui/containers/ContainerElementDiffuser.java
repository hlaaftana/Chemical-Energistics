...
public class ContainerElementDiffuser extends Container
{
    ...
    {
        this.elementDiffuser = te;
 
        this.addSlotToContainer(new Slot(elementDiffuser, 0, 63, 34));
        this.addSlotToContainer(new Slot(elementDiffuser, 1, 97, 34));
    ...
    public void addCraftingToCrafters(ICrafting crafting)
    {
    	...
    	crafting.sendProgressBarUpdate(this, 0, this.elementDiffuser.storage.getEnergyStored());
    }
    ...
    public void detectAndSendChanges()
    {
        ...
        for (int i = 0; i < this.crafters.size(); ++i)
        {
            ...
            if (this.energyStored != this.elementDiffuser.storage.getEnergyStored())
            {
                crafting.sendProgressBarUpdate(this, 0, this.elementDiffuser.storage.getEnergyStored());
            }
        }
        
        this.energyStored = this.elementDiffuser.storage.getEnergyStored();
    }
    ...
    {
        return elementDiffuser.isUseableByPlayer(player);
    }
}
